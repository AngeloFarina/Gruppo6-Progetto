...
public class Caserma {
	...
	private List<Vigile> vigili;
	
	public Caserma(String id,String citta, int cisterna, List<Mezzo> mezzi, List<Vigile> vigili) {
		this.setVigili(new ArrayList<Vigile>(vigili));
	...
	public void setVigili(List<Vigile> vigili) {
		this.vigili = vigili;
	}
